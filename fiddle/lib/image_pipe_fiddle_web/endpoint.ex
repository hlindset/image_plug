defmodule ImagePipeFiddleWeb.Endpoint do
  use Phoenix.Endpoint, otp_app: :image_pipe_fiddle
  ...
  @session_options [
    store: :cookie,
    key: "_image_pipe_fiddle_key",
    signing_salt: "9Eu+XDuw",
    same_site: "Lax"
  ]
  ...
  plug ImagePipeFiddleWeb.Router
end
